...
var pgnParser = (function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      peg$c5 = function(cm, mn, cb, hm, nag, ca, cd, vari, all) {
        var arr = all ? all : [];
        var move = {};
        move.turn = "w";
        move.moveNumber = mn;
      ...
      peg$c6 = function(cm, me, cb, hm, nag, ca, cd, vari, all) {
        var arr = all ? all : [];
        var move = {};
        move.turn = "b";
        move.moveNumber = me;
      ...
      peg$c29 = function(cas) {
        return cas;
      },
      peg$c30 = function(ca, cal) {
        var ret = {};
        if (cal) {
          var o = cal[0];
          return { ...ca, ...o };
      ...
      peg$c31 = function(caf) {
        var ret = {};
        ret.colorFields = caf;
        return ret;
      },
      peg$c32 = function(caa) {
        var ret = {};
        ret.colorArrows = caa;
        return ret;
      },
      peg$c33 = function(cac) {
        var ret = {};
        ret.clock = cac;
        return ret;
      },
      ...
      peg$c42 = function(col, f) {
        return col + f;
      },
      peg$c43 = function(col, ff, ft) {
        return col + ff + ft;
      },
      peg$c44 = "Y",
      ...
      peg$c82 = function(h1, h2, m1, m2, s1, s2) {
        var ret = h1;
        if (h2) {
          ret += h2;
        }
      ...
      peg$c86 = function(vari, all, me) {
        var arr = all ? all : [];
        arr.unshift(vari);
        return arr;
      },
      peg$c87 = function(vari, all) {
        var arr = all ? all : [];
        arr.unshift(vari);
        return arr;
      },
      ...
      peg$c100 = function(fig, disc, str, col, row, pr, ch) {
        var hm = {};
        hm.fig = fig ? fig : null;
      ...
      peg$c101 = function(fig, cols, rows, str, col, row, pr, ch) {
        var hm = {};
        hm.fig = fig ? fig : null;
      ...
      peg$c102 = function(fig, str, col, row, pr, ch) {
        var hm = {};
        hm.fig = fig ? fig : null;
        hm.strike = str ? str : null;
        hm.col = col;
                              ...
                              if (s0 === peg$FAILED) {
                                ...
                                if (s0 === peg$FAILED) {
                                  ...
                                  if (s0 === peg$FAILED) {
                                    s0 = peg$currPos;
                                    if (
                                      input.charCodeAt(peg$currPos) === 10865
                                    ) {
                                      s1 = peg$c161;
                                      peg$currPos++;
                                    } else {
                                    ...
                                    if (s0 === peg$FAILED) {
                                      s0 = peg$currPos;
                                      if (
                                        input.charCodeAt(peg$currPos) === 177
                                      ) {
                                        s1 = peg$c164;
                                        peg$currPos++;
                                      } else {
